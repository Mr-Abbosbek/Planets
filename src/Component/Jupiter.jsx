...
import ButtonL from "./jupiter/Button";
import ImageL from "./jupiter/Image0";
import ImageL1 from "./jupiter/Image1";
import ImageL2 from "./jupiter/Image2";
import TextL from "./jupiter/Text";
import TextL1 from "./jupiter/Text1";
import TextL2 from "./jupiter/Text2";
          ...
          <Col className="all-col p-0" key={post.id}>
            ...
            >
              ...
              <Col className="col-xl-8 col-lg-7 col-md-12 col-col-sm-12 col-12 py-lg-0 py-md-5 py-sm-5 py-5 px-0 d-flex align-items-center justify-content-center">
                <Switch>
                  <Route path={`/jupiter`} component={ImageL} exact />
                  <Route path={`/jupiter ${""}`} component={ImageL1} exact />
                  <Route path={`/jupiter ${" "}`} component={ImageL2} exact />
                </Switch>
              </Col>
              <Col className="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12 pt-lg-5 pt-md-0 pt-sm-0 px-0">
                <Row className="d-flex flex-lg-column align-items-md-center justify-content-md-between m-0">
                  <Col className="p-0 col-lg-12 col-md-6 col-sm-12 text-lg-start text-md-start text-sm-center text-center">
                    ...
                    <Switch>
                      <Route path={`/jupiter`} component={TextL} exact />
                      <Route path={`/jupiter ${""}`} component={TextL1} exact />
                      <Route path={`/jupiter ${" "}`} component={TextL2} exact />
                    </Switch>
                  </Col>
