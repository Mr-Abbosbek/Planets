...
import ButtonL from "./mars/Button";
import ImageL from "./mars/Image0";
import ImageL1 from "./mars/Image1";
import ImageL2 from "./mars/Image2";
import TextL from "./mars/Text";
import TextL1 from "./mars/Text1";
import TextL2 from "./mars/Text2";
          ...
          <Col className="all-col p-0" key={post.id}>
            ...
            >
              ...
              <Col className="col-xl-8 col-lg-7 col-md-12 col-col-sm-12 col-12 py-lg-0 py-md-5 py-sm-5 py-5 px-0 d-flex align-items-center justify-content-center">
                <Switch>
                  <Route path={`/mars`} component={ImageL} exact />
                  <Route path={`/mars ${""}`} component={ImageL1} exact />
                  <Route path={`/mars ${" "}`} component={ImageL2} exact />
                </Switch>
              </Col>
              <Col className="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12 pt-lg-5 pt-md-0 pt-sm-0 px-0">
                <Row className="d-flex flex-lg-column align-items-md-center justify-content-md-between m-0">
                  <Col className="p-0 col-lg-12 col-md-6 col-sm-12 text-lg-start text-md-start text-sm-center text-center">
                    ...
                    <Switch>
                      <Route path={`/mars`} component={TextL} exact />
                      <Route path={`/mars ${""}`} component={TextL1} exact />
                      <Route path={`/mars ${" "}`} component={TextL2} exact />
                    </Switch>
                  </Col>
