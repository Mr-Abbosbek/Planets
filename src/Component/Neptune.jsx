...
import ButtonL from "./neptune/Button";
import ImageL from "./neptune/Image0";
import ImageL1 from "./neptune/Image1";
import ImageL2 from "./neptune/Image2";
import TextL from "./neptune/Text";
import TextL1 from "./neptune/Text1";
import TextL2 from "./neptune/Text2";
          ...
          <Col className="all-col p-0" key={post.id}>
            ...
            >
              ...
              <Col className="col-xl-8 col-lg-7 col-md-12 col-col-sm-12 col-12 py-lg-0 py-md-5 py-sm-5 py-5 px-0 d-flex align-items-center justify-content-center">
                <Switch>
                  <Route path={`/neptune`} component={ImageL} exact />
                  <Route path={`/neptune ${""}`} component={ImageL1} exact />
                  <Route path={`/neptune ${" "}`} component={ImageL2} exact />
                </Switch>
              </Col>
